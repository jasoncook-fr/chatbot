...
Commands are also prepared for the chatbot. To send a command, simply begin the message with dollar sign. For example, to get a list of available commands simply type \$help
